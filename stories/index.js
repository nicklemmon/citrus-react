...
//   .add('with secondary type', () => (
//     <Button type="secondary" content="Secondary!" />
//   ))
//   .add('with tertiary type', () => (
//     <Button type="tertiary" content="Tertiary!" />
//   ))
//   .add('with full width style', () => (
//     <Button fullWidth={true} content="Full width!" />
//   ))
...
//     <Alert type="success" content="This is an success alert." />
//   ))
//   .add('with type attention', () => (
//     <Alert type="attention" content="This is an attention alert." />
//   ))
//   .add('with type info', () => (
//     <Alert type="info" content="This is an info alert." />
//   ))
//   .add('is dismissable', () => (
//     <AlertDismissable type="error" content="This is a dismissable alert" />
//   ))

// storiesOf('Card', module)
//   .add('with headingLevel and headingContent', () => (
//     <Card headingLevel="5" headingContent="Example Heading Content" />
//   ))
//   .add('with metaContent', () => (
//     <Card
//       headingLevel="5"
//       headingContent="Example Heading Content"
//       metaContent="07/04/1776"
//     />
//   ))
//   .add('with footerContent', () => (
//     <Card footerContent="Example footer content" />
//   ))
//   .add('with child elements', () => {
//     return (
//       <Card headingContent="Example Heading Content" headingLevel="5">
//         <p> I am a child element! </p>{' '}
//         <ButtonWrapper>
//           <Button type="primary" content="Continue" />

//           <Button type="secondary" content="Cancel" />

//           <Button type="tertiary" content="Back" />
//         </ButtonWrapper>{' '}
//       </Card>
//     )
//   })
...
//   .add('with no child elements', () => (
//     <Modal id="example-modal" heading="Example Modal" />
//   ))
//   .add('with child elements', () => {
//     return (
//       <Modal id="example-modal-2" heading="Example Modal with Child Elements">
...
//   .add('with some text content', () => (
//     <Accordion triggerContent="Accordion, yo">
//       <p> Herro. </p>{' '}
//     </Accordion>
//   ))
//   .add('open on mount', () => (
//     <Accordion triggerContent="Accordion open on mount" isOpen={true}>
//       <p> Herro. </p>{' '}
//     </Accordion>
//   ))
//   .add('with a minimal design', () => (
//     <Accordion type="minimal" triggerContent="Accordion with minimal design">
//       <p> Herro. </p>{' '}
//     </Accordion>
//   ))
...
// storiesOf('ToggleGroup', module).add('with some stuff', () => {
//   const stuff = [
//     {
//       content: '1'
//     },
...
//     }
//   ]
//   return <ToggleGroup id="example" type="radio" buttons={stuff} />
// })
